...
ARG="$ARG plot '-' using 1:2 with lines lt 1 lw 2 linecolor rgb 'blue' title '1000 ARS Steam Coupon cost in Eurocents', '-' using 1:3 with lines lt 1 lw 2 linecolor rgb 'red' title 'Currency - 1000 ARS to EUR'"
